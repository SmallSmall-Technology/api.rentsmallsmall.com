...
Route::get('database-health/connection', [DatabaseHealthController::class, 'checkDatabaseConnection']);
Route::get('database-health/tables', [DatabaseHealthController::class, 'checkTablesExist']);
Route::get('database-health/counts', [DatabaseHealthController::class, 'getTableCounts']);
